...
use crate::{DbPool, DbConnection, models::member::Member, auth::{validate_jwt_from_header, JwtClaims}, controllers::Resource};
...
pub fn get_controller<T: Resource>(pool: &DbPool, request: &HttpRequest) -> Result<T, Error> {
    Ok(
